...
--insert into product(p_id,cat_id,s_id,p_name,p_price,p_unit,p_details,p_image_path,is_deleted)
  --  values(default,2,2,'Potato',100,'1kg','organic','bfhbjhhfjh', default);

-- insert into product(p_id,cat_id,s_id,p_name,p_price,p_unit,p_details,p_image_path,is_deleted) 
--     values(default,3,3,'mung',120,'1kg','unpolhed','fdbnfjdbh', default);

-- insert into product(p_id,cat_id,s_id,p_name,p_price,p_unit,p_details,p_image_path,is_deleted)
--      values(default,4,4,'Olive',350,'1liter','best for salads','jhnerjther', default);
